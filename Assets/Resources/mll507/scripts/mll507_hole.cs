...
public class mll507_hole : Tile
{
	...
	{
		if (otherCollider.gameObject.GetComponent<Tile>() != null)
		{
			...
			if (!other_tile.hasTag(TileTags.Wall) && other_tile.tileName != "sand grenade")
			{
				...
				mll507_room room = transform.parent.gameObject.GetComponent<mll507_room>();
				int num_sands = room.sands.Count;
				...
				mll507_sand other_sand = room.sands[sand_idx];
